...
class VideoDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            if self.num_data == 10000:
                ...
                with h5py.File(data_path + 'h5py_train_frames_10k.h5', 'r') as hf:
                    ...
                    frame_list, mask_list = self._load_frame_mask(frame=frame, mode='train')
                # audio
            ...
            if self.testset == 'flickr':
                ...
                # frame
                frame_list, mask_list = self._load_frame_mask(path=frame_path, mode='test')
                # audio
                ...
                with h5py.File(data_path + 'h5py_test_frames.h5', 'r') as hf:
                    ...
                    frame_list, mask_list = self._load_frame_mask(frame=frame, mode='test')
                # audio
        ...
        # output
        output_dict = {'frame_view1': frame_list[0], 'frame_view2': frame_list[1], 'frame_orig': frame_list[-1],
                       'mask_view1': mask_list[0], 'mask_view2': mask_list[1], 'mask_orig': mask_list[-1],
                       'sound': audio, 'spect': spect}
        if self.mode == 'test':
